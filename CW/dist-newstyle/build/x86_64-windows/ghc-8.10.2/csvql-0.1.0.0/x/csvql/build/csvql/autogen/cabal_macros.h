...
/* package csvql-0.1.0.0 */
#ifndef VERSION_csvql
#define VERSION_csvql "0.1.0.0"
#endif /* VERSION_csvql */
#ifndef MIN_VERSION_csvql
#define MIN_VERSION_csvql(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_csvql */
...
#define CURRENT_COMPONENT_ID "csvql-0.1.0.0-inplace-csvql"
